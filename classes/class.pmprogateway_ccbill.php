...
//	require(PMPRO_URL. "/classes/gateways/class.pmprogateway.php");
	...
	class PMProGateway_CCBill extends PMProGateway
	{
		...
		{				
			...
			{	
				...
				//technically, the initial period can be different than the recurring period, but keep it consistant with the other integrations for now.
